...
const CACHE='openfuel-live-shell-v2';
const SHELL=['./','./index.html','./app.js','./styles.css','./vendor/leaflet.js','./vendor/leaflet.css'];
...
self.addEventListener('fetch',event=>{
  ...
  // Only the six application shell files are cached. Never intercept map tiles,
